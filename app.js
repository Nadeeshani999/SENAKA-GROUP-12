  ...
  function renderView(rows) {
    ...
    (()=>{
      ...
      function getBarGradient(p) {
        if (p >= 100) return 'linear-gradient(90deg,#06b6d4,#3b82f6)';
        if (p >= 90)  return 'linear-gradient(90deg,#6d28d9,#8b5cf6)';
        if (p >= 80)  return 'linear-gradient(90deg,#ea580c,#f97316)';
        if (p >= 65)  return 'linear-gradient(90deg,#f97316,#fb923c)';
        if (p >= 50)  return 'linear-gradient(90deg,#d97706,#fbbf24)';
        if (p >= 35)  return 'linear-gradient(90deg,#16a34a,#4ade80)';
        if (p >= 20)  return 'linear-gradient(90deg,#15803d,#22c55e)';
        return         'linear-gradient(90deg,#166534,#16a34a)';
      }
      function getStatus(p, tabStatus) {
        if (tabStatus === 'Completed' || p >= 100) return {label:'COMPLETED',   color:'#22c55e'};
        if (p >= 90)  return {label:'NEARLY DONE', color:'#8b5cf6'};
        if (p >= 80)  return {label:'AHEAD',        color:'#f97316'};
        if (p >= 65)  return {label:'IN PROGRESS',  color:'#f97316'};
        if (p >= 35)  return {label:'IN PROGRESS',  color:'#fbbf24'};
        if (p >= 10)  return {label:'ON TRACK',     color:'#22c55e'};
      ...
      displayRows.forEach(r => {
        ...
        const st = getStatus(p, r._tabStatus);
